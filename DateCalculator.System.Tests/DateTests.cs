...
namespace DateCalculator.System.Tests
{
    public class DateTests
    {
        ...
        public void Should_be_return_right_exception_when_operation_is_not_valid(string operation, string date, string amount)
        {
            #region Arrange
        ...
        public void Should_be_returned_right_exception_when_format_date_is_not_valid(string operation, string date, string amount)
        {
            #region Arrange
